...
# RSS Feed Configuration - Gemini's High-Reliability Sources
RSS_SOURCES = {
...
# Enhanced Precision Filtering Logic - Gemini + ADNOC/Borouge Specific
BOURUGE_RELEVANCE = {
    # GATE 1: PRIMARY STAKEHOLDERS (ADNOC/Borouge + Industry Standards)
    'entities': [
        # ADNOC/Borouge Specific (Your Core Business)
        ...
        # Industry Standards (Gemini's Professional Terms)
    ...
    # GATE 2: LOGISTICS CONTEXT (Gemini's Professional + Your Locations)
    'ports_routes': [
        # UAE/Gulf Critical Locations (Your Business)
        'Khalifa Port', 'Jebel Ali', 'Abu Dhabi', 'Dubai', 'Ruways', 'Ruwais', 'Fujairah', 'Sohar',
        
        # Global Maritime Chokepoints (Gemini's Strategic)
    ...
    # GATE 4: ENHANCED BLACKLIST (Gemini's + Your Comprehensive Filter)
    'blacklist': [
        # Gemini's "Noise" Filter
        ...
        'saudi aramco', 'aramco', 'saudi', 'saudi arabian', 'bp', 'shell', 'exxon', 'chevron',
        'total', 'equinor', 'hmt', 'reform hmt', 'british shipping', 'uk shipping policy',
...
# Email Configuration - Your Original + Gemini's Professional
EMAIL_CONFIG = {
...
# Monitoring Configuration - Gemini's Professional + Your Settings
MONITORING_CONFIG = {
    'check_interval_minutes': 30,
    'alert_window_hours': 24,  # Gemini's 24h window
