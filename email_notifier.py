...
class EmailNotifier:
    ...
    def create_email_body(self, articles: List[Dict]) -> str:
        ...
        # Email body with source verification
        email_body = f"""
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
            <div class="header">
                ...
                <p>Real-time logistics intelligence from authoritative sources</p>
            </div>
            
            <div class="content">
                <div class="source-warning">
                    <h3 class="source-verified">🛡️ Source Verification: Authoritative News Only</h3>
                    <p>All intelligence sourced from verified, reputable news organizations to ensure accuracy and reliability.</p>
                </div>
                ...
                <p><strong>Source Reliability:</strong> Authoritative news organizations only</p>
                
                {html_table}
                
                <h3>🎯 RECOMMENDED ACTIONS</h3>
                <ul>
                    <li>Verify all intelligence through official sources before action</li>
    ...
    def create_html_table(self, articles: List[Dict]) -> str:
        ...
        for i, article in enumerate(articles[:EMAIL_CONFIG['max_items']], 1):
            ...
            is_critical = any(keyword in title_lower or keyword in summary_lower 
                            for keyword in ['fire', 'attack', 'explosion', 'security breach'])
    ...
    def is_authoritative_source(self, source: str) -> bool:
        ...
        authoritative_sources = [
            'reuters', 'bbc', 'financial times', 'guardian', 'bloomberg',
            'wall street journal', 'marketwatch', 'cnbc', 'yahoo finance',
            'joc', 'splash247', 'hellenic shipping', 'lloyds list',
            'platts', 'icis', 'argus media', 'wam', 'the national', 'gulf news'
        ]
        ...
        try:
            ...
            <body>
                ...
                <div class="content">
                    ...
                    <div class="source-warning">
                        <h3>🛡️ Source Verification: Authoritative Sources Only</h3>
                        <p>All intelligence sourced from verified, reputable news organizations to ensure accuracy and reliability.</p>
                    </div>
                    ...
                    <ul>
                        ...
                        <li><strong>Source Reliability:</strong> Verified, reputable organizations</li>
                    </ul>
                    
                    <h3>🎯 What Happens Next</h3>
                    <p>The system will automatically scan for logistics intelligence from authoritative sources and send alerts when:</p>
                    <ul>
                        ...
                        <li>🔥 Critical infrastructure incidents (Ruwais, ADNOC, etc.)</li>
                    </ul>
