...
class EmailNotifier:
    ...
    def send_logistics_alert(self, articles: List[Dict]) -> bool:
        ...
        try:
            ...
            # Create text content
            text_content = self.create_text_content(articles)
    ...
    def create_html_content(self, articles: List[Dict]) -> str:
    ...
    def create_text_content(self, articles: List[Dict]) -> str:
        ...
        text += "=" * 50 + "\n"
        text += "📧 This logistics intelligence was automatically generated by the AI Logistics Monitor\n"
